...
export default function ChartIcon(props: Readonly<SvgProps>) {
  ...
  return (
    ...
    >
      ...
      />
      <path
        d="M8.6 3H7.4C7.2 3 7 3.2 7 3.4V9.6C7 9.8 7.2 10 7.4 10H8.6C8.8 10 9 9.8 9 9.6V3.4C9 3.2 8.8 3 8.6 3ZM5.6 7H4.4C4.2 7 4 7.2 4 7.4V9.6C4 9.8 4.2 10 4.4 10H5.6C5.8 10 6 9.8 6 9.6V7.4C6 7.2 5.8 7 5.6 7V7ZM14.6 2H13.4C13.2 2 13 2.2 13 2.4V9.6C13 9.8 13.2 10 13.4 10H14.6C14.8 10 15 9.8 15 9.6V2.4C15 2.2 14.8 2 14.6 2ZM11.6 5H10.4C10.2 5 10 5.2 10 5.4V9.6C10 9.8 10.2 10 10.4 10H11.6C11.8 10 12 9.8 12 9.6V5.4C12 5.2 11.8 5 11.6 5Z"
        fill="currentColor"
      />
    </svg>
  )
