...
export default function ArrowLeftLongIcon(
  ...
  const validWidth = typeof width === 'number' && !isNaN(width) ? width : 30
  const validHeight = typeof height === 'number' && !isNaN(height) ? height : 30

  // Getting the svg to export properly from figma was quite tricky
  return (
    <svg
      width={validWidth}
      height={validHeight}
